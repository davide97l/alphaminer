...
class MAVACv1(nn.Module):
    ...
    def __init__(
        ...
        actor_encoder_hidden_size_list: SequenceType = [256, 256, 128],
        critic_encoder_hidden_size_list: SequenceType = [256, 256, 128],
...
class MAVACv2(nn.Module):
    ...
    def __init__(
        ...
        action_shape: Union[int, SequenceType],
        agent_num: int = 500,
        encoder_hidden_size_list: SequenceType = [256, 128, 64],
